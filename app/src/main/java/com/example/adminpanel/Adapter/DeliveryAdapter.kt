...
import com.example.adminpanel.databinding.DeliveryLayoutBinding
...
class DeliveryAdapter(private val customerNames: MutableList<String>, private val moneyStatus: MutableList<Boolean>):
    RecyclerView.Adapter<DeliveryAdapter.DeliveryViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DeliveryViewHolder {
            val binding = DeliveryLayoutBinding.inflate(LayoutInflater.from(parent.context),parent,false)
        ...
        inner class DeliveryViewHolder(private val binding: DeliveryLayoutBinding):RecyclerView.ViewHolder(binding.root){
            fun bind(position: Int) {
                binding.apply {
                    custemerName.text=customerNames[position]
